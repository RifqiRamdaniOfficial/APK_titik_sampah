...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Daftar Laporan Titik Sampah</h1>
    </div>
    ...
    <form action="/dashboard/admin_reqs" class="col-lg-10">
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $req->region_id }}</td>
              <td>
                @if($req->status === 'sudah dibersihkan')
                  <span class="badge bg-success">Sudah Dibersihkan</span>
                @else
                  <span class="badge bg-danger">Belum Dibersihkan</span>
                @endif
              </td>
              <td>
